...
class APIWithComplexHeaderParametersClientBuilder
{
    /**
     * @var array
     */
    ...
    public function build(): APIWithComplexHeaderParametersClient
    {
        return new APIWithComplexHeaderParametersClient($this->config);
    }
}
