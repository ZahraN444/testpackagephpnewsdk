...
use APIWithComplexHeaderParametersLib\Utils\CompatibilityConverter;
use Core\ClientBuilder;
use Core\Utils\CoreHelper;
use Unirest\Configuration;
use Unirest\HttpClient;

class APIWithComplexHeaderParametersClient implements ConfigurationInterface
{
    private $client2;
    ...
    /**
     * @see APIWithComplexHeaderParametersClientBuilder::init()
     * @see APIWithComplexHeaderParametersClientBuilder::build()
     *
     * @param array $config
     */
     ...
     *
     * @return APIWithComplexHeaderParametersClientBuilder APIWithComplexHeaderParametersClientBuilder instance
     */
    public function toBuilder(): APIWithComplexHeaderParametersClientBuilder
    {
        return APIWithComplexHeaderParametersClientBuilder::init()
     ...
     *
     * @see APIWithComplexHeaderParametersClientBuilder::getConfiguration()
     */
     ...
     * @var array
     */
    private const ENVIRONMENT_MAP = [Environment::PRODUCTION => [Server::DEFAULT_ => 'http://localhost:3000']];
}
